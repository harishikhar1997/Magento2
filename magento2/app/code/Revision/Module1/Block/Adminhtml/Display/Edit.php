...
namespace Revision\Module1\Block\Adminhtml\Display;
...
class Edit extends Container
{
   /**
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Revision_Module1';
        ...
        'delete',
            array(
                ...
                'onclick' => 'setLocation("'.$this->getUrl('revision_module1/post/delete',array('_query' => array('deleteid' => $deleteId))).'")'
            ),
            -100
        );
    ...
    {
        $newsRegistry = $this->_coreRegistry->registry('revision_display');
