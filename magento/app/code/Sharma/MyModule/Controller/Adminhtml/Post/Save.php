...
class Save extends \Magento\Backend\App\Action
{
   ...
   public function __construct(
        ...
        \Sharma\MyModule\Model\PostFactory $postModelFactory,
   ...
   //    }
         ...
         // var_dump($model->getData());exit;
            ...
            $model->setUrlKey($postValues['url_key']);
            $model->setPostContent($postValues['post_content']);
            $model->setTags($postValues['tags']);
