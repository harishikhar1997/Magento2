...
namespace Sharma\MyModule\Block\Adminhtml\News;
...
class Edit extends Container
{
   /**
    ...
    protected function _construct()
    {
        ...
        'delete',
            array(
                ...
                'onclick' => 'setLocation("'.$this->getUrl('sharma_mymodule/post/delete',array('_query' => array('deleteid' => $deleteId))).'")'
            ),
            -100
        );
    ...
    {
        $newsRegistry = $this->_coreRegistry->registry('mymodule_news');
